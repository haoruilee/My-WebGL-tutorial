...
function collision_boundary(ball) {
    ...
    if (ball.vertices[0][0] >= 0.5 || ball.vertices[1][0] >= 0.5 || ball.vertices[2][0] >= 0.5 || ball.vertices[3][0] >= 0.5 || ball.vertices[4][0] >= 0.5 || ball.vertices[5][0] >= 0.5) {
        return [true, true];
    } else if (ball.vertices[0][1] >= 0.5 || ball.vertices[1][1] >= 0.5 || ball.vertices[2][1] >= 0.5 || ball.vertices[3][1] >= 0.5 || ball.vertices[4][1] >= 0.5 || ball.vertices[5][1] >= 0.5) {
        return [true, false];
    } else if (ball.vertices[0][0] <= -0.5 || ball.vertices[1][0] <= -0.5 || ball.vertices[2][0] <= -0.5 || ball.vertices[3][0] <= -0.5 || ball.vertices[4][0] <= -0.5 || ball.vertices[5][0] <= -0.5) {
        return [true, true];
    } else if (ball.vertices[0][1] <= -0.5 || ball.vertices[1][1] <= -0.5 || ball.vertices[2][1] <= -0.5 || ball.vertices[3][1] <= -0.5 || ball.vertices[4][1] <= -0.5 || ball.vertices[5][1] <= -0.5) {
        return [true, false];
    }
